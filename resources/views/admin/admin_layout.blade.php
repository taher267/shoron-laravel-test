...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="list-unstyled navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Fitness <sup></sup></div>
            </a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapseGallery" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('gallery.index')}}">All Photos</a>
                        <a class="collapse-item" href="{{route('gallery.create')}}">New Photo</a>
                    </div>
                </div>
            </li>
